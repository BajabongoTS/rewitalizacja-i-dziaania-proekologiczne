...
export const slides: SlideData[] = [
  ...
  {
    id: 5,
    title: "Rewitalizacja krajobrazów miast i przedmieść",
    type: "content",
    points: [
      "Dotyczy przemian na terenach dużych aglomeracji miejskich i ich przedmieść",
      "Obejmuje organizowanie programów społecznych dla mieszkańców",
      "Poprawa warunków mieszkaniowych i estetyki przestrzeni publicznej",
      "Samorządy mogą organizować programy poprawiające bezpieczeństwo i infrastrukturę",
      "Programy rewitalizacyjne prowadzone m.in. w Berlinie i Detroicie w Stanach Zjednoczonych",
    ],
  },
  {
    id: 6,
  ...
  },
  {
    ...
    points: [
      ...
      "Produkty ekologiczne oznaczane są unijnym znakiem 'liść z gwiazdek' (EU Organic Logo)",
  ...
  {
    id: 13,
    title: "Współodpowiedzialność i działania proekologiczne w naszym otoczeniu",
    type: "content",
    points: [
      ...
      "Segregacja odpadów i redukcja plastiku: torby wielorazowe, woda z kranu",
...
export const slideNotes: Record<number, string> = {
  ...
  5: "Rewitalizacja krajobrazów miast i przedmieść dotyczy przemian zachodzących na terenach dużych aglomeracji miejskich. W historii szybko zachodzących zmian przestrzennych w miastach pojawiały się problemy społeczne, a także naruszenie ładu przestrzennego. Jednym z narzędzi rewitalizacji jest organizowanie przez samorządy programów społecznych dla mieszkańców, a przy tym poprawianie warunków mieszkaniowych i bezpieczeństwa. Programy takie prowadzone są m.in. w Berlinie i Detroicie w Stanach Zjednoczonych.",
  6: "Obszary poprzemysłowe i pokolejowe to jedne z najważniejszych wyzwań rewitalizacyjnych w Polsce i Europie. Dawne fabryki, huty i stacje kolejowe zajmują rozległe tereny, często w centrum miast, które z czasem popadły w ruinę. Przykładem udanej rewitalizacji jest Manufaktura w Łodzi – dawna fabryka włókiennicza Izraela Poznańskiego przekształcona w nowoczesne centrum handlowo-rozrywkowo-kulturalne. Innym przykładem jest Stara Rzeźnia w Poznaniu, gdzie poprzemysłowy kompleks rzeźniany stał się przestrzenią kulturalną i gastronomiczną.",
  7: "Tereny powojskowe, podobnie jak poprzemysłowe, często zajmują duże, dobrze skomunikowane obszary w miastach lub ich pobliżu. Po zakończeniu zimnej wojny wiele baz wojskowych w Polsce i Europie stało się zbędnych i zostało przekazanych samorządom. Przykładem rewitalizacji jest Fort IV w Toruniu, dawny fort pruski zamieniony w obiekt hotelowo-turystyczny, oraz Cytadela w Poznaniu, przekształcona w jeden z największych parków miejskich w Polsce.",
  8: "W latach 60. i 70. XX w. w Europie powstawały masowo bloki z wielkich płyt – tzw. blokowiska. Dziś uważa się je za nieatrakcyjne społecznie. Rewitalizacja blokowisk obejmuje m.in. odnowienie fasad, docieplenie budynków, urządzenie terenów rekreacyjnych i parkingów. Powojenną zabudowę miejską ilustruje przykład Warszawy, gdzie w wyniku II wojny i Powstania Warszawskiego zniszczone zostało ok. 70% zabudowy. Odbudowa Starego Miasta – ponad 90% budynków – jest symbolicznym przykładem rewitalizacji.",
  9: "Działania proekologiczne w rolnictwie zmniejszają negatywny wpływ na środowisko. Obejmują m.in. stosowanie nawozów naturalnych, ograniczenie pestycydów, chów zwierząt w naturalnych warunkach. Ważna jest troska o warunki życia zwierząt, ochrona gleb i wód.",
  10: "Rolnictwo ekologiczne polega na rezygnacji ze sztucznych środków chemicznych. Największy udział powierzchni upraw ekologicznych mają Austria, Estonia i Włochy. Produkty ekologiczne oznaczane są unijnym znakiem 'listek z gwiazdek' (EU Organic Logo). Polska i Francja dynamicznie rozwijają ten sektor.",
  11: "Podstawowym działaniem proekologicznym w przemyśle jest wprowadzanie technologii zmniejszających negatywny wpływ na środowisko. Obejmuje to wykorzystywanie surowców wtórnych, recykling, zmniejszanie emisji CO₂ oraz zużycia wody i energii.",
  12: "W ostatnich latach wiele działań proekologicznych podejmuje się w usługach i transporcie. Przykładem są autobusy elektryczne w komunikacji miejskiej miast takich jak Paryż, Madryt i Ateny. Rozwija się także sieć ścieżek rowerowych. Ekoturystyka i agroturystyka stają się popularnymi alternatywnymi formami turystyki.",
  13: "Każdy człowiek może podejmować działania proekologiczne. Do pożądanych wyborów należą: kupowanie produktów lokalnych, wybieranie towarów z materiałów naturalnych i z recyklingu, używanie energooszczędnych żarówek, poruszanie się transportem miejskim lub rowerem. W naszym najbliższym otoczeniu ważna jest segregacja odpadów, redukcja plastiku poprzez korzystanie z toreb wielorazowych i picie wody z kranu, oszczędzanie wody przez zakręcanie kranu podczas mycia zębów i branie prysznica, zbieranie deszczówki do podlewania kwiatów, a także oszczędzanie energii poprzez wyłączanie światła i używanie energooszczędnych żarówek.",
  14: "",
  15: "",
};
